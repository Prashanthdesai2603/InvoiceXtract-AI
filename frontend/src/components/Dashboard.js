    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Take top 5 vendors and group others
    ...
    return (
        ...
        >
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Link to="/upload" className="btn btn-primary d-flex align-items-center px-4 fw-bold">
            ...
            <div className="row g-4 mb-5">
                <motion.div variants={itemVariants} className="col-md-6 col-lg-3">
                    <div className="card glass-card h-100 p-3 stat-card">
                ...
                {/* Dummy stats for visual completeness */}
                <motion.div variants={itemVariants} className="col-md-6 col-lg-3">
                    <div className="card glass-card h-100 p-3 stat-card">
                        <div className="d-flex justify-content-between align-items-start">
                            <div>
            ...
            <motion.div variants={itemVariants} className="card glass-card overflow-hidden">
                <div className="card-header bg-white bg-opacity-10 py-3 d-flex justify-content-between align-items-center">
                        ...
                        <tbody>
                            {recentInvoices.map((inv) => (
                                <tr key={inv.id}>
                                    ...
                                    <td>
                                        <span className={`badge rounded-pill ${inv.total_amount ? 'bg-success-subtle text-success' : 'bg-warning-subtle text-warning'}`}>
                                            {inv.total_amount ? 'Processed' : 'Pending'}
                                        </span>
                                    </td>
